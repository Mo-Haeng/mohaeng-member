package com.mohang.infrastructure.auth.jsonlogin.filter
...
class JsonLoginProcessingFilter(
    ...
    override fun attemptAuthentication(request: HttpServletRequest, response: HttpServletResponse): Authentication {
        ...
        return authenticationManager.authenticate(JsonUsernamePasswordToken(accountDto.username!!, accountDto.password));
    }
